...
#
# Generated by export_simulation on Tue Jun 08 23:36:42 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './rlc_design.sh' script.

./rlc_design.sh -reset_run
...
./rlc_design.sh -noclean_files

For more information on the script, please type './rlc_design.sh -help'.
